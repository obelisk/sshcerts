...
struct CoseKey {
    ...
    algorithm: i128,
    key: Vec<u8>,
    parameters: HashMap<i128, String>,
}
...
pub struct AuthData {
    ...
    /// The crate's SSH PublicKey type created from the parsed authentication
    /// data
...
pub fn parse_auth_data(auth_data_raw: &[u8], application: &[u8]) -> Result<AuthData, Error> {
