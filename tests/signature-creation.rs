...
#[test]
fn check_basic_creation_ecdsa_256_short_scalar_full_loop() {
    let private_key =
        PrivateKey::from_string(include_str!("keys/unencrypted/ecdsa_256_short_scalar")).unwrap();
    let public_key = private_key.pubkey.clone();
...
#[test]
fn check_basic_creation_ecdsa_384_short_scalar_full_loop() {
    let private_key =
        PrivateKey::from_string(include_str!("keys/unencrypted/ecdsa_384_short_scalar")).unwrap();
    let public_key = private_key.pubkey.clone();
